...
export default class AccountProfile extends React.Component {
    ...
    loadData() {
        ...
        $.ajax({
            url: 'https://talentservicesprofilestandard.azurewebsites.net/profile/profile/getTalentProfile',
            headers: {
    ...
    saveProfile() {
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'https://talentservicesprofilestandard.azurewebsites.net/profile/profile/updateTalentProfile',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
                                    ...
                                    <div className="ui grid">
                                        ...
                                        >
                                            <PhotoUpload
                                                ...
                                                saveProfileData={this.updateAndSaveData}
                                                savePhotoUrl={'https://talentservicesprofilestandard.azurewebsites.net/profile/profile/updateProfilePhoto'}
                                            />
                                        </FormItemWrapper>
                                        <FormItemWrapper
                                            title='Profile Video'
                                        ...
                                        >
                                            <VideoUpload
                                                ...
                                                saveVideoUrl={'https://talentservicesprofilestandard.azurewebsites.net/profile/profile/updateTalentVideo'}
                                            />
                                        </FormItemWrapper>
                                        <FormItemWrapper
                                            title='CV'
                                        ...
                                        >
                                            <CVUpload
                                                ...
                                                updateProfileData={this.updateWithoutSave}
                                                saveCVUrl={'https://talentservicesprofilestandard.azurewebsites.net/profile/profile/updateTalentCV'}
                                            />
                                        </FormItemWrapper>
                                        <FormItemWrapper
                                            title='Description'
